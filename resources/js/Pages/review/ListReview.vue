...
<template>
    ...
    <div v-if="props.reviews.length === 0" class="text-center text-gray-500 dark:text-gray-400">
        No reviews found.
    </div>
    ...
    <div v-else>
        ...
        <div class="space-y-4 border mb-2" v-for="review in filteredReviews" :key="review.id">
