...
<template>
    <!-- Modal toggle -->
    <div class="text-end">
        <button data-modal-target="add-modal" data-modal-toggle="add-modal" @click="showModal"
        ...
        <div class="relative w-full max-w-lg max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div
                    ...
                    <button type="button" id="add-modal-close" @click="hideModal"
                ...
                <form @submit.prevent="submitForm" class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <img v-if="coverImagePreview" :src="coverImagePreview" alt="Book Cover Preview"
