    ...
    <GuestLayout>
        ...
        <div class="py-16">
            <div class="flex bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                <div class="hidden lg:block lg:w-1/2 bg-cover bg-center" style="background-image:url('/imgs/book1.jpg')"></div>
                <div class="w-full p-8 lg:w-1/2">
                    <div class="text-center text-gray-600 dark:text-gray-200 font-bold text-lg mb-4">Sign Up</div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mt-8">
                            <button type="submit"
                                class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5"
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            ...
                            <Link :href="route('login')" class="text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-500 uppercase">
                                Sign in
                            </Link>
                            <span class="border-b w-1/5 md:w-1/4 dark:border-gray-600"></span>
                        </div>
